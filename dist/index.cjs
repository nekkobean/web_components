Object.defineProperty(exports,Symbol.toStringTag,{value:`Module`});var e=Object.create,t=Object.defineProperty,n=Object.getOwnPropertyDescriptor,r=Object.getOwnPropertyNames,i=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,o=(e,i,o,s)=>{if(i&&typeof i==`object`||typeof i==`function`)for(var c=r(i),l=0,u=c.length,d;l<u;l++)d=c[l],!a.call(e,d)&&d!==o&&t(e,d,{get:(e=>i[e]).bind(null,d),enumerable:!(s=n(i,d))||s.enumerable});return e},s=(n,r,a)=>(a=n==null?{}:e(i(n)),o(r||!n||!n.__esModule?t(a,`default`,{value:n,enumerable:!0}):a,n));let c=require(`react/jsx-runtime`),l=require(`react`);l=s(l,1);var u=()=>(0,c.jsx)(`span`,{className:`animate-spin rounded-full h-4 w-4 border-b-2 border-white`}),d=({variant:e=`primary`,label:t,isLoading:n=!1,disabled:r=!1,onClick:i,style:a})=>{let o={primary:`bg-primary-button text-primary`,secondary:`bg-secondary-button text-primary`,restore:`bg-restore-button text-primary`,delete:`bg-delete-button text-primary`,disabled:`bg-disabled-button text-primary`},s=n?(0,c.jsx)(u,{}):null,l=r||n;return(0,c.jsx)(`div`,{children:(0,c.jsxs)(`button`,{className:`${o[e]} flex items-center gap-3 px-4 py-2 rounded-2xl text-sm font-medium w-full justify-center md:w-70 lg:w-25
       ${l?`cursor-not-allowed opacity-50`:`hover:cursor-pointer`} ${a||``}`,disabled:l,onClick:i,children:[s,t]})})},f=({children:e})=>(0,c.jsx)(`div`,{className:`bg-primary w-full max-w-sm rounded-lg shadow-md overflow-hidden`,children:e}),p=({title:e,description:t})=>(0,c.jsxs)(`div`,{className:`p-10`,children:[(0,c.jsx)(`h2`,{className:`text-lg font-bold mb-2 text-black`,children:e}),(0,c.jsx)(`p`,{className:`text-gray text-sm font-normal`,children:t})]}),m=({children:e})=>(0,c.jsx)(`div`,{className:`flex justify-end gap-4 w-full p-4`,children:e}),h=({alt:e,image:t,children:n})=>(0,c.jsxs)(`div`,{className:`relative w-full h-48`,children:[(0,c.jsx)(`img`,{src:t,alt:e,className:`w-full h-full object-cover`}),n]}),g=({children:e})=>(0,c.jsx)(`footer`,{className:`\r
        w-full\r
        bg-gray\r
        text-white\r
...
\r
      ...
      `,children:e}),v=({email:e,phone:t,socials:n})=>(0,c.jsxs)(`div`,{className:`text-white`,children:[(0,c.jsx)(`h3`,{className:`\r
        ...
        `,children:t})]}),b=({title:e,links:t,onItemClick:n})=>(0,c.jsxs)(`div`,{className:`text-white`,children:[(0,c.jsx)(`h3`,{className:`\r
          ...
          text-lg\r
          font-semibold\r
        `,children:e}),(0,c.jsx)(`div`,{className:`flex flex-col gap-2`,children:t.map(e=>(0,c.jsx)(`a`,{href:e.href,onClick:()=>n?.(e.label),className:`hover:underline`,children:e.label},e.id))})]}),x=({children:e,onSubmit:t,className:n=``,...r})=>(0,c.jsx)(`form`,{onSubmit:t,className:`w-full max-w-sm ${n}`,...r,children:(0,c.jsx)(`div`,{className:`flex flex-col gap-1`,children:e})}),S=({children:e,style:t})=>(0,c.jsx)(`header`,{className:`w-full bg-white border-b border-light-gray shadow-sm ${t}`,children:(0,c.jsx)(`div`,{className:`flex items-center justify-between px-6 py-4`,children:e})}),C=({navDrawer:e=[],style:t,onItemClick:n})=>{let[r,i]=(0,l.useState)(!1);return(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(`button`,{onClick:()=>i(!0),className:` flex md:hidden items-center justify-center h-10 w-10 rounded-md hover:bg-gray-100`,children:(0,c.jsx)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,viewBox:`0 0 24 24`,fill:`currentColor`,className:`\r
            h-6\r
            w-6\r
            text-gray-700\r
...
\r
            px-5\r
            py-4\r
          `,children:[(0,c.jsx)(`h2`,{className:`text-lg font-semibold`,children:`Menu`}),(0,c.jsx)(`button`,{onClick:()=>i(!1),className:`\r
              flex\r
              items-center\r
              justify-center\r
\r
...
\r
    ...
    `,children:[(0,c.jsx)(`img`,{src:e,alt:r,className:`\r
        ...
        sm:h-10\r
        sm:w-10\r
        object-contain`}),(0,c.jsx)(`h1`,{className:`text-sm sm:text-lg font-bold text-blue`,children:t})]}),T=({navBar:e=[],style:t,onItemClick:n})=>(0,c.jsx)(`nav`,{className:`
        hidden
        md:flex
        gap-12
        justify-center
